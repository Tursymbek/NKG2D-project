...
expr_df <- FetchData(seurat_T, vars = ligands_found)
...
write.csv(corr, "TCAT_vs_NKG2DL_correlation_table_with_SUM.csv", row.names = FALSE)
...
p1 <- ggplot(corr_plot,
    ...
    labs(
        title = "Correlation between T-cell TCAT programs and NKG2D ligands",
        x = "NKG2D ligand",
...
p2 <- ggplot(corr_plot,
    ...
    labs(
        title = "T-cell TCAT programs vs NKG2D ligands",
        x = "NKG2D ligand",
        y = "T-cell TCAT program",
        color = "Spearman rho",
        size = "-log10(FDR)"
...
write.csv(top_hits, "TCAT_vs_NKG2DL_top_hits_with_SUM.csv", row.names = FALSE)

cat("Done.\n")
cat("Created files:\n")
cat("- TCAT_vs_NKG2DL_correlation_table_with_SUM.csv\n")
cat("- TCAT_vs_NKG2DL_correlation_heatmap_with_SUM.png\n")
cat("- TCAT_vs_NKG2DL_correlation_dotplot_with_SUM.png\n")
cat("- TCAT_vs_NKG2DL_top_hits_with_SUM.csv\n")
